...
//gcc -I./include -Wall -O2 -g -L./lib -L./final_product main.c -lMLV-0 -lSDL -lmingw32 -lSDLmain ./lib/libmingwex.a -o main
// Les types d'unites :
#define REINE 'r'
#define OUVRIERE 'o'
#define ESCADRON 'e'
...
int quantite_ouvriere_recolte(UListe colonie){
    int quantite = 0;
    Unite *curr = colonie;
    while (curr){
        if (OUVRIERE == curr->type && curr->toursrestant) { ++quantite; }
    }
    return quantite;
}
